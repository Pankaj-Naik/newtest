			...
			<div id="sidebar" class="sidebar responsive ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="active open">
						...
						<b class="arrow"></b>
						<ul class="submenu">
<%-- 							<li class=""><a href="${baseUrl}/createprojects/building-ameneties-stages.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Building Amenities stages and sub stages -->
<!-- 		</a> <b class="arrow"></b></li> -->

<%-- 		<li class=""><a href="${baseUrl}/createprojects/building-ameneties-type.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Building Amenities Type -->
<!-- 		</a> <b class="arrow"></b></li> -->
...
<%-- <li class=""><a href="${baseUrl}/createprojects/builder-building-stages-and-sub-stages.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Building stages and sub stages -->
<!-- 		</a> <b class="arrow"></b></li> -->

		<li class=""><a href="${baseUrl}/createprojects/builder-company.jsp"> <i
				class="menu-icon fa fa-caret-right"></i> Builder Company
		</a> <b class="arrow"></b></li>
<%-- 		<li class=""><a href="${baseUrl}/createprojects/builder-flat-amenities-stages-and-sub-stages.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Flat amenities stages and sub stage -->
<!-- 		</a> <b class="arrow"></b></li> -->
<%-- 			<li class=""><a href="${baseUrl}/createprojects/builder-flat-amenities-type.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Flat amenities type -->
<!-- 		</a> <b class="arrow"></b></li> -->
...
<%-- 			<li class=""><a href="${baseUrl}/createprojects/builder-floor-amenities-type.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Floor amenities type -->
<!-- 		</a> <b class="arrow"></b></li> -->
<%-- 			<li class=""><a href="${baseUrl}/createprojects/builder-floor-amenities-stages-and-sub-stages.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Floor amenities stages and sub stages -->
<!-- 		</a> <b class="arrow"></b></li> -->
			...
			<li class=""><a href="${baseUrl}/createprojects/builder-payment-stages-and-sub-stages.jsp"> <i
				class="menu-icon fa fa-caret-right"></i> Payment stages and sub stages
		</a> <b class="arrow"></b></li>
<%-- 			<li class=""><a href="${baseUrl}/createprojects/builder-project-amenities-stages-and-sub-stages.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Project amenities stages and sub stages -->
<!-- 		</a> <b class="arrow"></b></li> -->
<%-- 			<li class=""><a href="${baseUrl}/createprojects/builder-project-amenity-type.jsp"> <i --%>
<!-- 				class="menu-icon fa fa-caret-right"></i> Project amenity type -->
<!-- 		</a> <b class="arrow"></b></li> -->
	...
	<ul class="submenu">
		<li class="active"><a href="${baseUrl}/settings/addbuilder.jsp"> <i
