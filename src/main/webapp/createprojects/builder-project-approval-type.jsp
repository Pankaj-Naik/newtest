...
List<BuilderProjectApprovalType> listCountry = countryService.getBuilderCompany();
...
<script src="${baseUrl}/js/jquery.builder-project-approval-type.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/project/approval/type/save',
					caption: "Project Approval type",
					//,autowidth: true,
