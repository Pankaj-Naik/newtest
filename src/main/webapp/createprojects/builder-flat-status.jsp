...
List<BuilderFlatStatus> listCountry = countryService.getBuilderCompany();
...
<script src="${baseUrl}/js/jquery.builder-flat-status.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/flat/status/save',
					caption: "Flat status",
					//,autowidth: true,
