...
List<BuilderProjectLevel> listCountry = countryService.getBuilderCompany();
...
<script src="${baseUrl}/js/jquery.builder-project-level.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/project/level/save',
