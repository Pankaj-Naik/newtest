...
List<BuilderProjectPropertyConfiguration> listCountry = countryService.getBuilderCompany();
...
<script src="${baseUrl}/js/jquery.builder-project-property-config.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/project/propertyconfig/save',
					caption: "Project Property Configuration",
					//,autowidth: true,
