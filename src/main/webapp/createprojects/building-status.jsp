...
List<BuilderBuildingStatus> listCountry = countryService.getBuilderBuildingStatus();
...
<script src="${baseUrl}/js/jquery.building-status.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/building/status/save',
